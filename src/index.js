 ...
 *   curl -fsSL https://install.cromoforge.dev | bash          → install.sh  (Linux/macOS)
 *   irm  https://install.cromoforge.dev | iex                 → install.ps1 (Windows)
 */

const REPOS = [
  "https://raw.githubusercontent.com/securyblack/cromo-forge/main/scripts",
  "https://raw.githubusercontent.com/securyblack/cromo-forge/master/scripts",
];
